package com.example.admin.demo.thridwidget.guid.aty;
...
public class GuideHomeActivity extends Activity implements View.OnClickListener {
  ...
  public void onClick(View view) {
    switch (view.getId()) {
      case R.id.btn_aty:
        startActivity(new Intent(GuideHomeActivity.this, FullActivity.class));
        break;
      case R.id.btn_frag:
        startActivity(new Intent(GuideHomeActivity.this, FragActivity.class).putExtra("fragmentId",0));
        break;
      case R.id.btn_frag_view:
        startActivity(new Intent(GuideHomeActivity.this, FragActivity.class).putExtra("fragmentId",1));
        break;
      case R.id.btn_list:
        startActivity(new Intent(GuideHomeActivity.this, MyListActivity.class));
        break;
      case R.id.btn_more:
        startActivity(new Intent(GuideHomeActivity.this, SimpleGuideViewActivity.class));
        break;
      case R.id.btn_view:
        startActivity(new Intent(GuideHomeActivity.this, ViewActivity.class));
        break;
    }
  }
}
