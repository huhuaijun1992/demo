package com.example.admin.demo.permission;
...
public class PerimissionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.perimission_activty_layout);
    ...
    private void showToast(String text) {
        Toast.makeText(PerimissionActivity.this, text, Toast.LENGTH_SHORT).show();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn1:
                ...
                HiPermission.create(PerimissionActivity.this)
...
//                        .style(R.style.CusStyle)
            ...
            case R.id.btn4:
                ...
                HiPermission.create(PerimissionActivity.this).checkSinglePermission(Manifest.permission.CAMERA, new PermissionCallback() {
                    @Override
                    public void onClose() {
