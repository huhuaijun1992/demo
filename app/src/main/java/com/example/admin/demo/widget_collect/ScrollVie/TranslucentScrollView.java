...
public class TranslucentScrollView extends ScrollView {
    ...
    public void setTransView(View transView) {
        setTransView(transView, getResources().getColor(R.color.colorPrimary), ScreenUtils.dip2px(getContext(), DFT_TRANSSTARTY), ScreenUtils.dip2px(getContext(), DFT_TRANSENDY));
    }
