...
import com.example.admin.demo.widget_collect.ScrollVie.ActionBarClickListener;
import com.example.admin.demo.widget_collect.ScrollVie.TranslucentActionBar;
import com.example.admin.demo.widget_collect.ScrollVie.TranslucentScrollView;
 ...
 */
public class ScollViewTopImage extends BaseActivity implements ActionBarClickListener, TranslucentScrollView.TranslucentChangedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scrollview_top_image);
        init();
    }
