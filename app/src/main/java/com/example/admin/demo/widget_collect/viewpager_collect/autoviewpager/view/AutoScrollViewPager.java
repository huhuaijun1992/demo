package com.example.admin.demo.widget_collect.viewpager_collect.autoviewpager.view;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                touchX = ev.getX();
                touchY = ev.getY();
                xDistance += Math.abs(touchX - downX);
                yDistance += Math.abs(touchY - downY);
                downX = touchX;
                downY = touchY;
                if (getChildCount() > 1) {
            ...
            case MotionEvent.ACTION_UP:
                if (isStopByTouch && getChildCount() > 1) {
                    startAutoScroll();
                }
                break;
        }
