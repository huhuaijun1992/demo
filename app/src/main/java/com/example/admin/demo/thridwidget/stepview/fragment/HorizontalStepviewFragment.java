package com.example.admin.demo.thridwidget.stepview.fragment;
...
public class HorizontalStepviewFragment extends Fragment
{
    ...
    /*
     ...
     StepBean stepBean4 = new StepBean("完 成",-1);
